...
from passport_auth.api.v1.dashboard_admins import router as dashboard_admins_router
from passport_auth.api.v1.dashboard_analytics import router as dashboard_analytics_router
...
from passport_auth.api.v1.dashboard_users import router as dashboard_users_router
...
router.include_router(dashboard_admins_router)
...
router.include_router(dashboard_users_router)
